...
<div class="bg-img">
  <div class="container">
    <div class="topnav">
      ...
      <a href="cloudServerAddAlarm.jsp">Add Alarm</a>
      <a href="#contact">Update Alarm</a>
      <a href="#about">Retrieve Data</a>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form  action="CloudServlet" method="post"  enctype="multipart/form-data" >
                        <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Title</label>
                                <div class="col-md-6">
                                    <input type="text" id="email_address" class="form-control"  name="title" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">File</label>
                                <div class="col-md-6">
                                    <input type="file" id="password" class="form-control" name="file" required>
                                </div>
                            </div>
