...
<body>
<div class="container">
  <h2>User View File Change  Details</h2>
  <p></p>  
 ...
 <a href="cloudServerAddAlarm.jsp" class="previous">&laquo; Back</a>
  ...
  <%
						...
						String qry = "select * from updateuserfile";
    ...
    <tbody id="myTable">
      <% 
								 ...
								 <tr>
									...
									<td><a href="CloudRetrieveFileData?id=<%=rset.getString(1)%>">Retrieve</a></td>
									<td><a href="verifychangeData1.jsp?id=<%=rset.getString(1)%>">Verify</a></td>
